...
| 平台 | 下载链接 | 安装说明 |
|------|---------|---------|
| **macOS** (Apple Silicon) | [Taco AI-0.4.2-arm64.dmg](https://store.bjctykj.com/app-versions/macOS/1781289451_Taco_AI-0.4.2-arm64.dmg) | 双击 `.dmg` 挂载后拖入 `Applications` 文件夹 |
| **Windows** (x64) | [Taco AI Setup 0.4.2.exe](https://store.bjctykj.com/app-versions/Windows/1781290240_Taco_AI_Setup_0.4.2.exe) | 双击 `.exe` 按安装向导完成安装 |
