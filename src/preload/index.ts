...
import type { ChatSendPayload, ChatStreamPayload, ChatChunkData, AgentStreamPayload, AgentEventData, EditorId, TacoApi, SystemInfo, ProjectNote, McpServerInfo, ExternalBrowserStatus } from '../shared/ipc'
